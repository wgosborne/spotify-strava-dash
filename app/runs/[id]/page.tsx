    ...
    <div className="max-w-4xl mx-auto px-4 py-6 md:py-8">
      ...
      <div className="mb-8 grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="glass-panel rounded-lg p-4">
          <p className="text-sm text-gray-500 uppercase tracking-wide mb-1 font-light" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.4)' }}>Date</p>
          <p className="text-spotify-green font-bold text-base leading-tight">{activity.start_date.toLocaleDateString()}</p>
          <p className="text-gray-400 text-sm font-light">{activity.start_date.toLocaleTimeString()}</p>
        </div>
        <div className="glass-panel rounded-lg p-4">
          <p className="text-sm text-gray-500 uppercase tracking-wide mb-1 font-light" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.4)' }}>Distance</p>
        ...
        <div className="glass-panel rounded-lg p-4">
          <p className="text-sm text-gray-500 uppercase tracking-wide mb-1 font-light" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.4)' }}>Moving Time</p>
          <p className="text-spotify-green font-bold text-xl leading-tight">{formatMovingTime(activity.moving_time)}</p>
        </div>
        <div className="glass-panel rounded-lg p-4">
          <p className="text-sm text-gray-500 uppercase tracking-wide mb-1 font-light" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.4)' }}>Pace</p>
