      ...
      <body className="text-white flex flex-col min-h-screen">
        <nav className="bg-black/80 border-b border-dark sticky top-0 z-50">
          <div className="max-w-4xl mx-auto px-4 py-4 flex gap-8">
            ...
            <Link href="/plays" className="text-spotify-green font-semibold hover:opacity-80">
              Plays
            </Link>
            <Link href="/runs" className="text-spotify-green font-semibold hover:opacity-80">
              Runs
            </Link>
            <Link href="/insights" className="text-spotify-green font-semibold hover:opacity-80">
              Insights
            </Link>
          </div>
        </nav>
